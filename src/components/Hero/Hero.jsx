            ...
            <section className="w-full min-h-[750px]">
                <div className="container">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 place-items-center min-h-[850px]">
                        ...
                        <div className="relative">
                            <img src={Coffemain} alt="black coffe"
                                 className="relative z-40 h-[400px] md:h-[700px] img-shadow"
                            />
                            <div
                                className="h-[180px] w-[180px] absolute top-24 -left-16 border-primary border-[20px] rounded-full z-10"></div>
                        ...
                        <div className="text-lightOrange mt-[100px] md:mt-0 p-4 space-y-28 max-lg:hidden">
                            <h1 className="opacity-0 text-7xl font-bold leading-tight mr-14">بلک کافی</h1>
                            <div className="relative">
                                <div className="relative z-10 space-y-4">
                                    <h1 className="text-2xl"> عاشقان لایف استایل مشکی</h1>
                                    <h1 className="text-sm opacity-55 leading-loose">
